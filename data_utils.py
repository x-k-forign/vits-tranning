...
class TextAudioSpeakerLoader(torch.utils.data.Dataset):
    ...
    def get_audio(self, filename):
        ...
        if sample_rate != self.sampling_rate:
            raise ValueError(f"Sampling rate mismatch: expected {self.sampling_rate}, got {sample_rate}")
        ...
        # else:
        #     try:
        spec = spectrogram_torch(waveform, self.filter_length, self.sampling_rate, self.hop_length, self.win_length, center=False)
        spec = spec.squeeze(0)
